...
class BaseURLTests(TestCase):
    ...
    def test_aws_new_baseurl(self):
        ...
        cases = [
            ...
            ###
            Case(
                ("https://abcd-123456789012.s3-accesspoint.amazonaws.com",
                 None),
                {
                    "s3_prefix": "abcd-123456789012.s3-accesspoint.",
                    "domain_suffix": "amazonaws.com",
                    "region": None,
                    "dualstack": False,
                },
            ...
            Case(
                ("https://abcd-123456789012.s3-accesspoint."
    ...
    def test_aws_list_buckets_build(self):
        ...
        cases = [
            ...
            Case(
                ("https://abcd-123456789012.s3-accesspoint.amazonaws.com",
                 None),
                "https://abcd-123456789012.s3-accesspoint.us-east-1."
                "amazonaws.com/",
            ),
            Case(
                ("https://abcd-123456789012.s3-accesspoint.amazonaws.com",
                 "ap-south-1a"),
                "https://abcd-123456789012.s3-accesspoint.ap-south-1a."
                "amazonaws.com/",
            ),
            Case(
                ("https://abcd-123456789012.s3-accesspoint."
                 "us-gov-east-1.amazonaws.com",
                 None),
                "https://abcd-123456789012.s3-accesspoint.us-gov-east-1."
                "amazonaws.com/",
            ),
            Case(
                ("https://abcd-123456789012.s3-accesspoint."
                 "us-gov-east-1.amazonaws.com",
                 "cn-northwest-1"),
                "https://abcd-123456789012.s3-accesspoint.cn-northwest-1."
                "amazonaws.com/",
            ),
            ###
            Case(
    ...
    def test_aws_bucket_build(self):
        ...
        cases = [
            ...
            Case(
                ("https://abcd-123456789012.s3-accesspoint.amazonaws.com",
                 None),
                "https://my-bucket.abcd-123456789012.s3-accesspoint.us-east-1."
                "amazonaws.com/",
            ),
            Case(
                ("https://abcd-123456789012.s3-accesspoint.amazonaws.com",
                 "ap-south-1a"),
                "https://my-bucket.abcd-123456789012.s3-accesspoint."
                "ap-south-1a.amazonaws.com/",
            ),
            Case(
                ("https://abcd-123456789012.s3-accesspoint."
