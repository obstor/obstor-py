...
from obstor.compat import HTTPHeaderDict, HTTPResponse
...
class EnvObstorProvider(Provider):
    """Credential provider from Obstor environment variables."""

    def retrieve(self) -> Credentials:
        """Retrieve credentials."""
        return Credentials(
            access_key=os.environ.get("OBSTOR_ACCESS_KEY") or "",
            secret_key=os.environ.get("OBSTOR_SECRET_KEY") or "",
        )
