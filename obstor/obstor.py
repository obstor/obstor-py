...
class Obstor:
    ...
    def __init__(
        ...
        """
        Initializes a new Obstor client object.
    ...
    def _rdma(self):
        """Lazy ctypes binding to libobstorcpp.so.
    ...
    def list_buckets(
        ...
        Returns:
            Iterator[ListAllMyBucketsResult.Bucket]:
                An iterator of
                :class:`obstor.models.ListAllMyBucketsResult.Bucket` objects.
    ...
    def listen_bucket_notification(
        ...
        Returns:
            EventIterable:
                An iterator of :class:`obstor.models.EventIterable` containing
                event records.
    ...
    def fget_object(
        ...
        Returns:
            GetObjectResponse:
                An :class:`obstor.models.GetObjectResponse` object containing
                the object data.
        ...
        # Write to a temporary file "file_path.ETAG.part.obstor" before saving.
        tmp_file_path = (
            tmp_file_path or f"{file_path}.{etag}.part.obstor"
        )
    ...
    def get_object_attributes(
        ...
        Returns:
            GetObjectAttributesResponse:
                An :class:`obstor.models.GetObjectAttributesResponse` object
    ...
    def get_object_acl(
        ...
        Returns:
            GetObjectAclResponse:
                An :class:`obstor.models.GetObjectAclResponse` object
    ...
    def prompt_object(
        ...
        Returns:
            PromptObjectResponse:
                An :class:`obstor.models.PromptObjectResponse` object.
    ...
    def copy_object(
        ...
        Example:
            ...
            >>> from obstor.args import Directive, SourceObject
            >>>
    ...
    def compose_object(
        ...
        Example:
            >>> from obstor.args import SourceObject
    ...
    def put_object_fan_out(
        ...
        fields.append(("x-obstor-fanout-list", fan_out_list))
        fields.append(
            (
                "file",
    ...
    def list_objects(
        ...
        Args:
            ...
            include_user_meta (bool, default=False):
                Obstor-specific flag to include user metadata.
        ...
        Returns:
            Iterator[Object]:
                An iterator of :class:`obstor.models.Object`.
    ...
    def stat_object(
        ...
        Returns:
            StatObjectResponse:
                A :class:`obstor.response.StatObjectResponse` object
    ...
    def remove_objects(
        ...
        Args:
            ...
            objects (Iterable[DeleteRequest.Object]):
                Iterable of :class:`obstor.request.DeleteRequest.Object`
        ...
        Returns:
            Iterator[DeleteResult.Error]:
                An iterator of :class:`obstor.models.DeleteResult.Error`
    ...
    def get_bucket_replication(
        ...
        Returns:
            Optional[ReplicationConfig]:
                A :class:`obstor.models.ReplicationConfig` object
    ...
    def get_bucket_lifecycle(
        ...
        Returns:
            Optional[LifecycleConfig]:
                A :class:`obstor.models.LifecycleConfig` object if
    ...
    def get_bucket_tags(
        ...
        Returns:
            Optional[Tags]:
                A :class:`obstor.models.Tags` object if tags are
                configured, otherwise ``None``.
    ...
    def set_bucket_tags(
        ...
        Args:
            ...
            tags (Tags):
                ...
                :class:`obstor.models.Tags` object.
    ...
    def get_object_lock_config(
        ...
        Returns:
            ObjectLockConfig:
                A :class:`obstor.models.ObjectLockConfig`
    ...
    def get_object_retention(
        ...
        Returns:
            Optional[Retention]:
                A :class:`obstor.models.Retention` object if retention
    ...
    def _list_objects(
            ...
            *,
            ...
            include_user_meta: bool = False,  # Obstor specific listV2.
