...
class ObstorException(Exception):
    """Base Obstor exception."""


class InvalidResponseError(ObstorException):
...
class ServerError(ObstorException):
...
class ObstorAdminException(Exception):
